...
// ShieldedConfPred RealData_acc95_conf995
// --conf_pred_cte lib/acc95/real_cte_pred_acc95_conf995.csv
// --conf_pred_he lib/acc95/real_he_pred_acc95_conf995.csv
...
// Generated: 2025-04-16 13:28:53.554933
...
module ShieldedConfPred
  ...
  // Perceiver (CTE)
  [] cte=0 & pc=0 -> 0.9065934065934066 : (cte_est0'=1) & (cte_est1'=0) & (cte_est2'=0) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) + 0.09340659340659341 : (cte_est0'=1) & (cte_est1'=1) & (cte_est2'=0) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) ;
  [] cte=1 & pc=0 -> 0.8959537572254336 : (cte_est0'=0) & (cte_est1'=1) & (cte_est2'=0) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) + 0.028901734104046242 : (cte_est0'=0) & (cte_est1'=1) & (cte_est2'=1) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) + 0.07514450867052024 : (cte_est0'=1) & (cte_est1'=1) & (cte_est2'=0) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) ;
  [] cte=2 & pc=0 -> 0.8874172185430463 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=1) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) + 0.052980132450331126 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=1) & (cte_est3'=1) & (cte_est4'=0) & (pc'=1) + 0.059602649006622516 : (cte_est0'=0) & (cte_est1'=1) & (cte_est2'=1) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) ;
  [] cte=3 & pc=0 -> 0.007633587786259542 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=0) & (cte_est3'=0) & (cte_est4'=1) & (pc'=1) + 0.7938931297709924 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=0) & (cte_est3'=1) & (cte_est4'=0) & (pc'=1) + 0.09923664122137404 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=0) & (cte_est3'=1) & (cte_est4'=1) & (pc'=1) + 0.007633587786259542 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=1) & (cte_est3'=0) & (cte_est4'=0) & (pc'=1) + 0.0916030534351145 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=1) & (cte_est3'=1) & (cte_est4'=0) & (pc'=1) ;
  [] cte=4 & pc=0 -> 0.9574468085106383 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=0) & (cte_est3'=0) & (cte_est4'=1) & (pc'=1) + 0.0425531914893617 : (cte_est0'=0) & (cte_est1'=0) & (cte_est2'=0) & (cte_est3'=1) & (cte_est4'=1) & (pc'=1) ;

  // Perceiver (HE)
  [] he=0 & pc=1 -> 0.9874213836477987 : (he_est0'=1) & (he_est1'=0) & (he_est2'=0) & (pc'=2) + 0.012578616352201259 : (he_est0'=1) & (he_est1'=1) & (he_est2'=0) & (pc'=2) ;
  [] he=1 & pc=1 -> 0.011764705882352941 : (he_est0'=0) & (he_est1'=0) & (he_est2'=1) & (pc'=2) + 0.9764705882352941 : (he_est0'=0) & (he_est1'=1) & (he_est2'=0) & (pc'=2) + 0.011764705882352941 : (he_est0'=1) & (he_est1'=1) & (he_est2'=0) & (pc'=2) ;
  [] he=2 & pc=1 -> 0.9970326409495549 : (he_est0'=0) & (he_est1'=0) & (he_est2'=1) & (pc'=2) + 0.002967359050445104 : (he_est0'=0) & (he_est1'=1) & (he_est2'=1) & (pc'=2) ;
