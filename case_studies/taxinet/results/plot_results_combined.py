...
def plotResults(N, props_no, output_file, colour, lw, results_label):
	...
	prop_crash=1-vals[:,4] ## 1-p is prob of being safe and not getting stuck
	# prop_stuck=vals[:,3]
	cap_size=10
...
ax_crash.set_ylabel('Probability of safe operation and not getting stuck', fontsize=20)
