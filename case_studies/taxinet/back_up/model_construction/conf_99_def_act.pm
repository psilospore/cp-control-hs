...
const N;
const double a_success=0.95;
const double a_fail=(1-a_success)/2.0;
...
[] (default=1 | default=2) & (a_last_rotate<1) & (beta<N) & pc=3 -> 1: (a'=0) & (beta'=beta+1) & (pc'=-2);
[] (default=1 | default=2) & (a_last_rotate=1) & (beta<N) & pc=3 -> 1: (a'=2) & (beta'=beta+1) & (pc'=-2);
[] (default=1 | default=2) & (a_last_rotate=2) & (beta<N) & pc=3 -> 1: (a'=1) & (beta'=beta+1) & (pc'=-2);
//  1/3.0: (a'=0) & (beta'=beta+1) & (pc'=-2) +
//  1/3.0: (a'=1) & (beta'=beta+1) & (pc'=-2) +
//  1/3.0: (a'=2) & (beta'=beta+1) & (pc'=-2);
// [] default=0 & pc=3 -> 1: (pc'=-2);
[dc_used] pc=-2 -> 1: (default'=0)&(pc'=4);


// Stochastic Dynamics

[] a=0 & pc=4 -> a_success : (a'=0) & (pc'=5) + a_fail : (a'=1) & (pc'=5)&(a_last_rotate'=1) + a_fail : (a'=2) & (pc'=5)&(a_last_rotate'=2);
[] a=1 & pc=4 -> a_success : (a'=1) & (pc'=5)&(a_last_rotate'=1) + a_fail : (a'=0) & (pc'=5) + a_fail : (a'=2) & (pc'=5)&(a_last_rotate'=2);
[] a=2 & pc=4 -> a_success : (a'=2) & (pc'=5)&(a_last_rotate'=2) + a_fail : (a'=1) & (pc'=5)&(a_last_rotate'=1) + a_fail : (a'=0) & (pc'=5);
